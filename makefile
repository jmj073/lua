...
CORE_T=	liblua.a
CORE_O=	lapi.o last.o lcode.o lcodegen.o lcont.o lctype.o ldebug.o ldo.o ldump.o lfunc.o lgc.o llex.o \
	lmem.o lobject.o lopcodes.o lparser.o lstate.o lstring.o ltable.o \
	ltm.o lundump.o lvm.o lzio.o ltests.o
AUX_O=	lauxlib.o
LIB_O=	lbaselib.o ldblib.o liolib.o lmathlib.o loslib.o ltablib.o lstrlib.o \
	lutf8lib.o loadlib.o lcorolib.o lcontlib.o linit.o
...
lbaselib.o: lbaselib.c lprefix.h lua.h luaconf.h lauxlib.h lualib.h \
 llimits.h
lcontlib.o: lcontlib.c lprefix.h lua.h luaconf.h lauxlib.h lualib.h \
 llimits.h
